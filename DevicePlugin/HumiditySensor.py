...
class HumiditySensor(Device):
    ...
    def __init__(self,id_dev="",location_dev="unknown",humidity=0,unit="unit"):
        super(HumiditySensor, self).__init__(id_dev, location_dev, type_dev="HumiditySensor")
    ...
    def make_active(device):
        ...
        def job_to_do(active):
                with active.locker:       
                    active.dev.humidity=random.randint(1,100)
