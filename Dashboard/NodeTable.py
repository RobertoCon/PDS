    ...
    def getHtml(nodes):
        ...
        for node in nodes['node_templates'] :
            ...
            """ % (str(i),nodes['node_templates'][node]['id'],nodes['node_templates'][node]['attributes']['public_address'],\
                   ...
                   <button type="submit" value="'+nodes['node_templates'][node]['id']+'" name="remove_node_id" class="btn btn-default btn-lg"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>\
                   </form>')
